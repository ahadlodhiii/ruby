module Spree
  module ProductsHelper
    ...
    def vendor_products(p_id, v_id)
      return [] unless @product.respond_to?(:has_vendor_products?) && @product.has_vendor_products?(v_id)
      @vendor_products ||= Spree::Product.
          where(vendor_id: v_id).where.not(id: p_id).
          includes(
              :tax_category,
              master: [
                  :prices,
